...
export const apps: AppProps[] = [
  {
    ...
    style: "text-sky-700 bg-white p-2 rounded shadow-xs shadow-black",
    label: "Old Portolio",
    id: "oldportfolio",
    iWidth: 500,
    iHeight: 400,
  },
  {
    ...
    Component: Credits,
    url: credit_icon,
    style: "text-white bg-yellow-600 p-2 rounded shadow-xs shadow-black",
    label: "Credits",
    id: "credits",
    iWidth: 400,
    iHeight: 370,
  },
  {
    ...
    Component: Wordle,
    url: wordle_icon,
    style: "text-white bg-[#55a459] p-2 rounded shadow-xs shadow-black",
    label: "Wordle",
    id: "wordle",
    iWidth: 300,
    iHeight: 450,
  },
  {
    ...
    Component: Tictactoe,
    url: tictactoe_icon,
    style: "text-white bg-amber-700 p-2 rounded shadow-xs shadow-black",
    label: "Tictactoe",
    id: "tictactoe",
    iWidth: 300,
    iHeight: 400,
...

  {
    ...
    Component: AboutMe,
    url: aboutme_icon,
    style: "text-amber-900 bg-amber-300 p-2 rounded shadow-xs shadow-black",
    label: "About Me",
    id: "about",
    iWidth: 400,
    iHeight: 400,
  },
  {
    ...
    Component: Guide,
    url: guide_icon,
    style: "text-green-200 bg-green-900 p-2 rounded shadow-xs shadow-black",
    label: "Guide",
    id: "guide",
    iWidth: 300,
    iHeight: 390,
