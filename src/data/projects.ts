...
export const projects = [
  ...
  },
  {
    ...
    desc: [
      ...
      "This is also the first time I used Framer Motion to create animations, unlike before when I manually handled them with vanilla JavaScript",
  ...
  },
  {
    ...
    desc: [
      "AICEE is my thesis project for the final semester of my bachelor's (January - June 2024). It began when my team and I pitched our web application project to Forte Digital, who tasked us to demonstrate the potential use of AI in web applications.",
  ...
  },
  {
    ...
    desc: [
      ...
      "I chose to create this type of project as my practice because I'm interested in learning more about pixel art. The game focuses on exploring dungeon rooms and jumping between platforms to progress to the next room.",
  ...
  },
  {
    ...
    desc: [
      ...
      "The app's main feature, 'Feedback Mode,' utilizes GPT to provide users with a feedback, color, and a rating based on their answers (see Figure 8).",
