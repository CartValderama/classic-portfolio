    ...
    >
      <AnimatePresence>
          ...
          >
            ...
            {bootMessages.map((text, index) => (
              <motion.p
                ...
                className={`text-xl 2xl:[@media(min-height:960px)]:text-3xl ${
        ...
        {currentStage === 1 && start && (
          ...
          >
            <h1 className="text-2xl 2xl:[@media(min-height:960px)]:text-4xl">
              Welcome to My Personal Portfolio
            </h1>
            <p className="text-lg 2xl:[@media(min-height:960px)]:text-2xl">
