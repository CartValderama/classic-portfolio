...
const Header = () => {
  ...
  return (
    ...
    >
      <nav className="w-full 3xl:max-w-[1800px] 2xl:max-w-[1600px] max-w-[1360px] border-x border-dashed border-[#e4e4e7b3] dark:border-[#27272ab3] mobile:px-8 px-4 py-5 flex justify-between items-center ">
