...
const Phone = () => {
  ...
  return (
    ...
    >
      <div className="w-full h-full relative [@media(max-height:450px)]:border-0 mobile:border-2 bg-[#2b2b2e] border-[#262627] mobile:rounded-[7rem] [@media(max-height:450px)]:rounded-none ">
        ...
        <div className="[@media(max-height:450px)]:border-0 mobile:border-10 border-[#242429] mobile:rounded-[7rem] w-full h-full ">
          <div className="[@media(max-height:450px)]:border-0 mobile:border-2 border-[#515455] mobile:rounded-[6rem] w-full h-full flex flex-col items-center justify-center">
            <div className="[@media(max-height:450px)]:border-0 mobile:border-2 border-[#171718] mobile:rounded-[6rem] w-full h-full flex flex-col items-center justify-center bg-[#131314] p-4 mobile:px-8 [@media(max-height:450px)]:rounded-none [@media(max-height:450px)]:px-4 mobile:[@media(max-height:450px)]:flex-row-reverse">
              <div className="flex flex-col justify-center items-center w-full mb-5 mobile:[@media(max-height:450px)]:flex-row-reverse mobile:[@media(max-height:450px)]:py-0 mobile:[@media(max-height:450px)]:h-full mobile:[@media(max-height:450px)]:w-auto mobile:[@media(max-height:450px)]:mb-0 mobile:[@media(max-height:450px)]:ml-5">
                <div className="flex items-center justify-between w-full mobile:[@media(max-height:450px)]:flex-col mobile:[@media(max-height:450px)]:h-full mobile:[@media(max-height:450px)]: mobile:[@media(min-height:450px)]:w-auto">
                  ...
                  <div className="bg-[#1e1e1e] border-2 border-[#464646] w-5 h-5 rounded-full mr-5 flex items-center justify-center mobile:[@media(min-height:450px)]:mr-0 mobile:[@media(max-height:450px)]:mt-5">
              ...
              <div className="w-full flex items-center justify-center mt-5 mobile:[@media(max-height:450px)]:mt-0 mobile:[@media(max-height:450px)]:mr-5 mobile:[@media(max-height:450px)]:w-auto mobile:[@media(max-height:450px)]:h-full">
                <button
                  className="w-20 h-12 border-3 border-[#515455] rounded-xl active:scale-98 cursor-pointer mobile:[@media(max-height:450px)]:w-12 mobile:[@media(max-height:450px)]:h-20"
                  onClick={() => {
                    setShowApps(false);
                    handleActiveWindows();
                  }}
