...
const Phone = () => {
  ...
  return (
    ...
    >
      <div className="w-full h-full min-h-[600px] max-h-[950px] mobile:w-[600px] mobile:min-h-[800px] mobile:max-h-[1000px] mobile:[@media(max-height:450px)]:w-full mobile:[@media(max-height:450px)]:min-h-auto mobile:[@media(max-height:450px)]:h-full relative [@media(max-height:450px)]:border-0 mobile:border-2 bg-[#2b2b2e] border-[#262627] mobile:rounded-[7rem] [@media(max-height:450px)]:rounded-none ">
