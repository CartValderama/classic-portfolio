...
const Monitor = () => {
  ...
  return (
    <motion.div
      initial={{ scale: 0.4 }}
      animate={start ? { scale: 1, y: 90 } : { scale: 0.4 }}
      transition={{ duration: 0.6, delay: 1 }}
      layout="position"
      className={`flex flex-col items-center w-full absolute -right-[30%] ${
        start ? "right-0 mt-25 2xl:mt-0" : "mr-12 xl:mr-0 mt-10"
      }`}
    >
      {/* monitor head*/}
      <div
        className={`bg-[#dbd49d] w-[65rem] h-[55rem] relative rounded-2xl flex flex-col items-center justify-between py-10 shadow-lg shadow-[#847959] dark:shadow-[#0b0b0b]`}
      >
        {/* main screen */}
        <div className="w-[92%] h-[88%] rounded-xl relative flex justify-center items-start">
        ...
        {/* monitor buttons*/}
        <div className="flex flex-row-reverse items-center justify-between w-[88%]">
