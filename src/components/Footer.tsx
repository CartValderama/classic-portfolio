...
const Footer = () => {
  ...
  return (
    ...
    >
      <div className="w-full 3xl:max-w-[1660px] max-w-[1360px] border-x border-dashed font-normal border-[#e4e4e7b3] dark:border-[#27272ab3] mobile:px-8 px-4 py-5 text-[#71717a] dark:text-white">
        <p>
