...
const Wordle = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center w-full h-full overflow-auto bg-white border border-white border-t-none border-l-[#868a8e] leading-6 px-4 gap-y-4 py-4">
      <div className="flex flex-col items-center gap-y-1 w-full h-[60%]">
