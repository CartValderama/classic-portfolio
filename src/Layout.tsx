...
const Layout = () => {
  ...
  return (
    ...
    >
      ...
      >
        <nav className="w-full max-w-[85rem] 2xl:max-w-[96rem] border-x border-dashed border-[#e4e4e7b3] dark:border-[#27272ab3] px-8 py-5 flex justify-between items-center ">
      ...
      >
        <div className="w-full max-w-[85rem] 2xl:max-w-[96rem] border-x border-dashed font-normal border-[#e4e4e7b3] dark:border-[#27272ab3] px-8 py-5 text-[#71717a] dark:text-white">
          <p>
